...
var $author$project$Main$FetchProductsResponse = function (a) {
	return {$: 'FetchProductsResponse', a: a};
};
...
var $author$project$Main$colorOptionDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$ColorOption,
	A2($elm$json$Json$Decode$field, 'colorCode', $elm$json$Json$Decode$string),
...
var $author$project$Main$fetchProducts = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$FetchProductsResponse, $author$project$Main$productsDecoder),
		url: 'http://127.0.0.1:8000/products.json'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{currentIndex: 0, error: $elm$core$Maybe$Nothing, products: _List_Nil},
	...
	function (msg, model) {
		switch (msg.$) {
				...
				if (msg.a.$ === 'Ok') {
					...
					var updatedProducts = A2(
						...
						function (p) {
							var _v1 = p.colors;
							if (_v1.b) {
								var firstColor = _v1.a;
								return _Utils_update(
									p,
									{selectedColor: firstColor, showInsideView: false});
							} else {
								return p;
							}
						},
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentIndex: 0, error: $elm$core$Maybe$Nothing, products: updatedProducts}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to fetch products')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'SelectColor':
				...
				var updatedProducts = A2(
					$elm$core$List$map,
					function (p) {
						return _Utils_eq(p.id, productId) ? _Utils_update(
							p,
							{selectedColor: color, showInsideView: false}) : p;
					},
					model.products);
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'ToggleInsideView':
				...
				var updatedProducts = A2(
					...
					function (p) {
						return _Utils_eq(p.id, productId) ? _Utils_update(
							p,
							{showInsideView: !p.showInsideView}) : p;
					},
					model.products);
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'PreviousProduct':
				var prevIndex = (model.currentIndex > 0) ? (model.currentIndex - 1) : ($elm$core$List$length(model.products) - 1);
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				var nextIndex = (_Utils_cmp(
					model.currentIndex,
					$elm$core$List$length(model.products) - 1) < 0) ? (model.currentIndex + 1) : 0;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$NextProduct = {$: 'NextProduct'};
var $author$project$Main$PreviousProduct = {$: 'PreviousProduct'};
...
var $author$project$Main$SelectColor = F2(
	function (a, b) {
		return {$: 'SelectColor', a: a, b: b};
	});
var $author$project$Main$ToggleInsideView = function (a) {
...
var $author$project$Main$viewProduct = function (product) {
	var selectedImage = product.showInsideView ? product.selectedColor.insideImageUrl : product.selectedColor.outsideImageUrl;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(selectedImage),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('view-inside-button'),
						$elm$html$Html$Events$onClick(
						$author$project$Main$ToggleInsideView(product.id))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
				...
				A2(
					...
					function (color) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('color-circle'),
									A2($elm$html$Html$Attributes$style, 'background-color', color.colorCode),
									$elm$html$Html$Attributes$class(
									_Utils_eq(color.colorCode, product.selectedColor.colorCode) ? 'active-color' : ''),
									$elm$html$Html$Events$onClick(
									A2($author$project$Main$SelectColor, product.id, color))
								]),
							_List_Nil);
					},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('arrow left-arrow'),
						$elm$html$Html$Events$onClick($author$project$Main$PreviousProduct)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('<')
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$viewProduct,
					A2(
						$elm$core$List$take,
						3,
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('arrow right-arrow'),
						$elm$html$Html$Events$onClick($author$project$Main$NextProduct)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('>')
